import sdk, { Battery, DeviceDiscovery, DeviceProvider, Dock, Pause, Refresh, ScryptedDeviceBase, ScryptedDeviceType, ScryptedInterface, Setting, Settings, SettingValue, StartStop } from '@scrypted/sdk';
...
const miio = require('../homebridge-xiaomi-roborock-vacuum/src/miio');
        ...
        for (const server of servers) {
            try {
                ...
                for (const device of devices.result.list) {
                    ...
                    const vacuum = await this.getDevice(device.mac);
